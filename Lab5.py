...
#df = pd.read_csv("/content/drive/My Drive/lab4.csv", delimiter = ",", index_col = [0], na_values = ['NA'], low_memory = False)
...
test_model(model)
'''
#df_new = pd.read_csv("/content/drive/My Drive/lab4-Тюмень.csv", delimiter = ",", index_col = [0], na_values = ['NA'], low_memory = False)
...
#copy.to_csv("/content/drive/My Drive/lab5.csv",  na_rep = 'NA', index = True, index_label = "", quotechar = '"', quoting = csv.QUOTE_NONNUMERIC, encoding = "utf-8-sig")
